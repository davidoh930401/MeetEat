...
<form action="./MemberJoinAction.me" method="post" name="join" id="join" onsubmit="return checkValue()">
 <fieldset class="card bg-light mb-6 col-8">
	...
	<div class="p-5">
		...
		<div class="form-group row">
 			<label class="form-label mt-4 col-sm-2">ID</label>
	    ...
	    <div class="form-group">
	      <label class="form-label mt-4 col-sm-2">Password</label>
	    ...
	    <div class="mt-4 float-sm-end">
			    <input type="submit" value="가 입" class="btn btn-lg btn-success px-6">
